        ...
        changelog: [
            {
                title: "New Stuff",
                items: [
                    "**Support server**: I now have a support server (https://discord.gg/QpMrV3NqCD)",
                ],
            },
            {
                title: "Improvements",
                type: "improved",
                items: ["**Time Select**: It is finally a number input!!!"],
            },
        ],
        main: "index.js",
    };
...
.timestamp-modal-time:not(:last-of-type) { display: -webkit-box; float: left; padding-right: 24px; }
.timestamp-modal-time input { width: 124px; }`,
    ...
    <button aria-label="Enter timestamp" type="button" class="buttonWrapper-1ZmCpA button-318s1X button-38aScr lookBlank-3eh9lL colorBrand-3pXr91 grow-q77ONN">
        ...
        NumberInput = WebpackModules.getByDisplayName("NumberInputStepper"),
        ...
        showTimesampModal() {
            ...
            let inputDate = new Date(), inputTime = new Date(), inputFormat = "f",
                ...
                timeInput = BdApi.React.createElement(FormItem, {
                    ...
                    title: "Time",
                    children: [
                        BdApi.React.createElement(createUpdateWrapper(NumberInput), { className: 'timestamp-modal-time', onChange: (format) => inputTime.setHours(format), value: inputTime.getHours(), minValue: 0, maxValue: 23 }),
                        BdApi.React.createElement(createUpdateWrapper(NumberInput), { className: 'timestamp-modal-time', onChange: (format) => inputTime.setMinutes(format), value: inputTime.getMinutes(), minValue: 0, maxValue: 59 })
                    ]
                }),
